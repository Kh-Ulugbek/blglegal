        ...
        <div
            ...
            <nav class="mt-5 h-full flex-shrink-0 divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
                <div class="space-y-1 px-2">
                    ...
                    <a
                        wire:navigate
                        href="{{ route('admin.document.editor') }}" class="@if(request()->route()->getName() == 'admin.document.editor') bg-cyan-800 text-white @else text-cyan-100 hover:bg-cyan-600 hover:text-white @endif group flex items-center rounded-md px-2 py-2 text-base font-medium">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-4 h-6 w-6 flex-shrink-0 text-cyan-200">
