                ...
                <div class="u-row"
                    ...
                    <div
                        ...
                        <td align="center" width="600"
                            style="background-color: #ddffe7;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"
                            valign="top"><![endif]-->
                                                    ...
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0"
                                                                 src="{{ asset('assets/img/logo.png') }}" alt="image"
                                                                 title="image"
                                                                 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 490px;"
                                                                 width="490"/>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td><![endif]-->
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;">
                                                    <span><span>Your one-time code is</span></span></h1>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div align="center">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:42px; v-text-anchor:middle; width:216px;"
                                                                 arcsize="0%" strokecolor="#000000" strokeweight="2px"
                                                                 fillcolor="#ffffff">
                                                        <w:anchorlock/>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 140%;">Please verify you're really you by
                                                        entering this</p>
                                                    <p style="line-height: 140%;">6-digit code when you sign in. Just a
                                                        heads up, this code will expire</p>
                                                    <p style="line-height: 140%;">in 20 minutes for security
                                                        reasons.</p>
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td><![endif]-->
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 18px; font-weight: 700;">
                                                    <span><span><span><span>We noticed you signed in from a<br/>new location or device</span></span></span></span>
                                                </h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                ...
                <div class="u-row"
                    ...
                    <div
                        ...
                        <td align="center" width="200"
                            style="background-color: #ffffff;width: 200px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"
                            valign="top"><![endif]-->
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0"
                                                                 src="{{ asset('assets/img/email/image-5.png') }}"
                                                                 alt="image" title="image"
                                                                 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 22%;max-width: 39.6px;"
                                                                 width="39.6"/>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td><![endif]-->
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 16px; font-weight: 700;">
                                                    <span>Device:</span></h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    style="font-size: 14px; line-height: 110%; text-align: center; word-wrap: break-word;">
                                                    <p style="line-height: 110%;">Chrome 111.0.0</p>
                                                    <p style="line-height: 110%;">Windows 10</p>
                                                </div>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0"
                                                                 src="{{ asset('assets/img/email/image-8.png') }}"
                                                                 alt="image" title="image"
                                                                 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 22%;max-width: 39.6px;"
                                                                 width="39.6"/>
                                    ...
                                    <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    style="font-size: 14px; line-height: 110%; text-align: center; word-wrap: break-word;">
                                                    <p style="line-height: 110%;">San Francisco,</p>
                                                    <p style="line-height: 110%;">CA 94114</p>
                                                </div>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0"
                                                                 src="{{ asset('assets/img/email/image-7.png') }}"
                                                                 alt="image" title="image"
                                                                 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 22%;max-width: 39.6px;"
                                                                 width="39.6"/>
                                    ...
                                    <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    style="font-size: 14px; line-height: 110%; text-align: center; word-wrap: break-word;">
                                                    <p style="line-height: 110%;">Monday, 20 March 2023 at 11:31:10
                                                        pm</p>
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td><![endif]-->
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 16px; font-weight: 400;">
                                                    <span>If you didn't just try to sign in,<br/>we recommend you reset your password here:</span>
                                                </h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div align="center">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                 href="https://unlayer.com"
                                                                 style="height:40px; v-text-anchor:middle; width:274px;"
                                                                 arcsize="0%" strokecolor="#000000" strokeweight="2px"
                                                                 fillcolor="#000000">
                                                        <w:anchorlock/>
                                                    ...
                                                    <a href="https://unlayer.com" target="_blank"
                                                       ...
                                                       style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #000000; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:48%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #000000; border-top-style: solid; border-top-width: 2px; border-left-color: #000000; border-left-style: solid; border-left-width: 2px; border-right-color: #000000; border-right-style: solid; border-right-width: 2px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 2px;font-size: 18px;">
                                                        <span
                                                            style="display:block;padding:10px 20px 8px;line-height:120%;">Reset Your Password</span>
                                                    </a>
                                                    <!--[if mso]></center></v:roundrect><![endif]-->
                                                </div>
            ...
            <div class="u-row-container" style="padding: 2px 0px 0px;background-color: transparent">
                <div class="u-row"
                    ...
                    <div
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding: 2px 0px 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: transparent;"><![endif]-->
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 13px; font-weight: 400;">
                                                    <span><span><span><span>If you have any questions, contact our Website  Guides.<br/>Or, visit our Help Center.</span></span></span></span>
                                                </h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
