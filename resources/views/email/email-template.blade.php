...
<body class="clean-body u_body"
      style="margin: 50px 0 0 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f0f0f0;color: #000000">
<!--[if IE]>
                ...
                <div class="u-row"
                    ...
                    <div
                        ...
                        <td align="center" width="600"
                            style="background-color: #fcdeb3;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"
                            valign="top"><![endif]-->
                                                    ...
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0"
                                                                 ...
                                                                 title="image"
                                                                 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 430px;"
                                                                 width="430"/>
                    ...
                    <div
                        ...
                        <div class="u-col u-col-100"
                            ...
                            <div
                                ...
                                <div
                                    style="box-sizing: border-box; height: 100%; padding: 0px 10px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;">
                                                                <span>Congratulations Your Request Has Been Accepted</span>
                                                            </h1>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 140%;">
                                                        ...
                                                        Accusantium alias animi assumenda atque, delectus, eos error
                                                        excepturi in labore minus modi mollitia nobis pariatur rerum
                                                        similique? Illum praesentium temporibus voluptate.
                                                    </p>
                                                </div>
                                                ...
                                                <div align="center">
                                                    ...
                                                    <a href="https://unlayer.com" target="_blank"
                                                       ...
                                                       style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #000000; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:48%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #000000; border-top-style: solid; border-top-width: 2px; border-left-color: #000000; border-left-style: solid; border-left-width: 2px; border-right-color: #000000; border-right-style: solid; border-right-width: 2px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 2px;font-size: 18px;">
                                                        <span
                                                            style="display:block;padding:10px 20px 8px;line-height:120%;">Sign Contract</span>
                                                    </a>
